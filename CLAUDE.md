...
- Effectifs mondiaux (27 sept.) : milices ~4,9 Md, régulière 47,5 M, forces spéciales 350 000 (majorité en Amérique du Sud), **Division Phoenix 12 600 au total**, en deux divisions de 6 300 (Amérique du Sud contre les entités faibles, Asie contre les fortes). Tués confédérés par corps : `meta.tuesParCorps`. Marine : 15 divisions, ~78 000 marins, placées face aux bulles cultistes et autour de Ganzir.
...
- Quarantaines : en Afrique, seul le district expérimental (la côte en est sortie) ; en Asie, le District Philippin (Philippines, nord de l'Indonésie, Malaisie orientale, Brunei), depuis le 20 sept. ; en Amérique du Sud, un cordon (barrière) autour du foyer de Nargal depuis le 22 sept. (`cordon: true` sur la zone).
- Projets technologiques de la R&D (dossiers `rd/*`, la Smith Technologies Corporation et les accords de Stockholm ne sont plus à mentionner) : installé = CLS, GGP, RESS, Télescope Stockholm, TDA ; en fabrication = Station Arachne, ancre de réalité d'Eucrynomos (27 sept. 2075 → 20 mars 2076, 25 tours) ; en recherche = Singularité, SPA (très peu avancé), SPMQN.
